<!-- Space: Projects -->
<!-- Parent: ZshNvm -->
<!-- Title: Contributing GithubFlow ZshNvm -->
<!-- Label: ZshNvm -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-nvm project on [GitHub](https://github.com/hadenlabs/zsh-nvm), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-nvm/pulls).
...
To follow the instructions in this guide and start contributing to zsh-nvm project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-nvm.git
```

Now your **upstream** points to **hadenlabs/zsh-nvm**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-nvm
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-nvm/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
