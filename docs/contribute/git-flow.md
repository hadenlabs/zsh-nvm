<!-- Space: Projects -->
<!-- Parent: ZshNvm -->
<!-- Title: Contributing GitFlow ZshNvm -->
<!-- Label: ZshNvm -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GitFlow -->
...
To contribute to zsh-nvm project on [GitHub](https://github.com/hadenlabs/zsh-nvm), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-nvm/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to zsh-nvm project on Gitlab:
